...
int nxt(int t){
    if(0 <= t && t < 5) return 5;
    else if(5 <= t && t < 9) return 9;
    else if(9 <= t && t < 12) return 12;
    else if(12 <= t && t < 14) return 14;
}
...
int main()
{
    ...
    printf("Enter player:\n");
    printf("1 as first player or 2 as second player\n");
    scanf("%d", &player_turn);
    printf("select colour:\n");
    printf("R is for RED or B is for BLUE\n");
    scanf(" %c", &colour);
